...
export class EpicConnectionPodRepository {
  ...
  async get(): Promise<EpicConnectionRecord | null> {
    ...
    try {
      ...
      return {
        ...
        encryptedPkceCodeVerifier: readJson(thing, `${health}epicEncryptedPkceCodeVerifier`),
        authorizationEndpoint: readJson(thing, `${health}epicAuthorizationEndpoint`),
        tokenEndpoint: readJson(thing, `${health}epicTokenEndpoint`),
  ...
  async save(record: EpicConnectionRecord): Promise<EpicConnectionRecord> {
    ...
    for (const [predicate, value] of Object.entries({
      ...
      epicEncryptedPkceCodeVerifier: record.encryptedPkceCodeVerifier,
      epicAuthorizationEndpoint: record.authorizationEndpoint,
      epicTokenEndpoint: record.tokenEndpoint,
